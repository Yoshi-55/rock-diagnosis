...
export const resultPatterns = [
    ...
    minScore: 80,
    type: "🎸 True Rockstar",
    description: "あなたは生まれながらのロックスター！自分の信念を貫き、情熱的に生きています。周りに流されず、自分らしさを大切にするその姿は多くの人を惹きつけます。",
    advice: "その情熱とカリスマ性を活かして、リーダーシップを発揮していきましょう！",
    color: "#ff6b6b"
},
{
    minScore: 60,
    type: "🎵 Rock Spirit Holder",
    description: "あなたの中には確かなロック魂が宿っています！自分の価値観を持ちながらも、周りとのバランスを取れる素晴らしい人です。",
    advice: "もう少し積極的に自分の意見を表現すると、さらにロック度がアップするかもしれません！",
    color: "#4ecdc4"
},
{
    minScore: 40,
    type: "🎼 Rock Trainee",
    description: "ロックの素質は十分にあります！もう少し自分の気持ちに正直になることで、内なるロック魂が目覚めるでしょう。",
...
},
{
    minScore: 0,
    type: "🌸 Gentle Soul",
    description: "あなたは協調性があり、周りとの調和を大切にする優しい人です。ロックとは違う、あなたならではの魅力がたくさんあります。",
